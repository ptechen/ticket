...
class CrackTouClick(object):
    ...
    def zuihou(self):
        self.browser.find_element_by_xpath('//*[@id="btnProceed"]').click()
    # def write_info(self):
    #     print("start write_info")
    #     time.sleep(5)
    #     self.browser.switch_to.frame("paymentPageFrame")
    #     self.wait.until(EC.presence_of_element_located((By.ID, 'expireMonth')))
    #     self.browser.find_element_by_xpath('//*[@id="expireMonth"]').send_keys('01')
    #     self.browser.find_element_by_xpath('//*[@id="expireYear"]').send_keys(23)
    #     self.browser.find_element_by_xpath('//*[@id="cvn2"]').send_keys('011')
    #     time.sleep(100)
    #     # self.browser.find_element_by_xpath('//*[@id="cellPhoneNumber"]').send_keys(15736755067)
    #     self.browser.find_element_by_xpath('//*[@id="btnGetCode"]').click()
    #     self.browser.find_element_by_xpath('//*[@id="btnCardPay"]').click()
...
if __name__ == '__main__':
    ...
    #                    "key_url": "https://ticket.urbtix.hk/internet/zh_TW/eventDetail/38726",
